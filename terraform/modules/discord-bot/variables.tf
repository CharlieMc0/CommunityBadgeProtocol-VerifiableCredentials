...
# variable "discord_whitelist_role_id" {
#   type        = string
#   description = "The Discord Role ID allowed to whitelist their wallet address"
# }

# variable "discord_server_id" {
#   type        = string
#   description = "The Guild ID for the Discord Server"
# }
...
# variable "whitelist_capacity" {
#   type        = number
#   description = "The maximum number of addresses that can be whitelisted"
# }